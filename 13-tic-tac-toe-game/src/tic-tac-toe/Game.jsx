...
function Game() {
  ...
  // 첫번째 플레이어의 턴인가요?
  // [null, '🩷', null, null, null, '❌', null, null, null]
  const isPlayerOneTurn = // true(0, -0 이 아닌 숫자) , false(0, -0인 숫자)
    currentSquares.filter(Boolean).length % PLAYER_COUNT === 0; // true (0 , 1)
  // currentSquares.filter(item=>item).length % PLAYER_COUNT === 0; // true
